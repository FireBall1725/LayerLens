  ...
  private var overlayTab: some View {
    ...
    return Form {
      ...
      Section("Hold duration") {
        ...
        Text(
          "How long the overlay stays visible after the last layer change before fading out. Doesn't apply while the overlay is pinned via \"Show Overlay.\""
        )
        .font(.caption)
        .foregroundStyle(.secondary)
      }
  ...
  private var privacyTab: some View {
    ...
    return Form {
      Section("Anonymous usage telemetry") {
        Toggle(
          "Help improve LayerLens by sharing anonymous usage",
          isOn: Binding(
        ...
        Text(
          "Off by default. When on, LayerLens sends a small set of anonymous signals via TelemetryDeck. No personally identifying data ever leaves your machine."
        )
        .font(.caption)
        .foregroundStyle(.secondary)
      }
      ...
      Section("What's sent") {
        privacySettingsRow(
          ...
          color: .green,
          body:
            "macOS version, CPU type, app version, locale. Keyboard VID:PID and kind (QMK or Vial). Whether the firmware module is installed and which mode it's in."
        )
      }
      ...
      Section("Never sent") {
        privacySettingsRow(
          ...
          color: .secondary,
          body:
            "Keystrokes, layer contents, custom labels. Your name, hostname, IP address. Anything that could identify you or what you're typing."
        )
      }
  ...
  private var devTab: some View {
    Form {
      ...
      Section("Dev tools") {
        ...
        Text(
          "Turning this off hides the Dev tab. Your feature-flag selections are remembered, so re-unlocking restores them."
        )
        .font(.caption)
        .foregroundStyle(.secondary)
      }
